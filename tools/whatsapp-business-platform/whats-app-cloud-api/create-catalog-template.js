 ...
 * @param {string} args.language - The language code for the catalog template.
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          language: {
            type: 'string',
            description: 'The language code for the catalog template.'
          },
          category: {
            type: 'string',
          ...
          components: {
            ...
            items: {
              ...
              properties: {
                type: {
                  type: 'string',
                  description: 'The type of the component (e.g., BODY, FOOTER, BUTTONS).'
                },
                text: {
                  type: 'string',
                ...
                buttons: {
                  ...
                  items: {
                    ...
                    properties: {
                      type: {
                        type: 'string',
                        description: 'The type of the button (e.g., CATALOG).'
                      },
                      text: {
                        type: 'string',
