 ...
 * @param {string} args.version - The API version to use (e.g., "v16.0").
 * @returns {Promise<Object>} - The response from the WhatsApp API containing the message template details.
 */
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          version: {
            type: 'string',
            description: 'The API version to use (e.g., "v16.0").'
          }
        },
