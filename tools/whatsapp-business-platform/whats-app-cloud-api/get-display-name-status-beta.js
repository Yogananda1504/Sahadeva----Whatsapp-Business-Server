 ...
 * @param {string} args.phoneNumberId - The phone number ID to check the display name status for.
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          phoneNumberId: {
            type: 'string',
            description: 'The phone number ID to check the display name status for.'
          }
        },
