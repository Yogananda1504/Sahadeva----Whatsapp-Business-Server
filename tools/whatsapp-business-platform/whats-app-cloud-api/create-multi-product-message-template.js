          ...
          components: {
            ...
            items: {
              ...
              properties: {
                type: {
                  type: 'string',
                  description: 'The type of the component (e.g., HEADER, BODY, BUTTONS).'
                },
                format: {
                  type: 'string',
                  description: 'The format of the component (e.g., TEXT).'
                },
                text: {
                  type: 'string',
                ...
                buttons: {
                  type: 'array',
                  description: 'The buttons for the component, if applicable.',
                  items: {
                    type: 'object',
                    properties: {
                      type: {
                        type: 'string',
                        description: 'The type of button (e.g., MPM).'
                      },
                      text: {
                        type: 'string',
